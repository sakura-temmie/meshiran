    ...
    <>
      <div className="fullPageScroll">
        <section id="section1" className="section section1 relative">
          <div className="text-center p-2" style={{ background: "#f00a00" }}>
            <p className="font-bold text-white">ユーザー名さんの投稿</p>
          </div>
          ...
          <div className="absolute bottom-10 p-4 bg-gray-50 bg-opacity-80 w-full">
            <div className="flex">
              <svg
            ...
            <p className="w-full">
              とてもおいしかったです。ご飯によく合います。
            </p>
          </div>
          <div className="text-center p-2 absolute bottom-0 w-full bg-gray-100 flex justify-between px-6">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
